		...
		["Default"] = {
			...
			["triggers"] = {
				["Custom1"] = {
					...
					["fontSize"] = 26,
					["alwaysSticky"] = true,
					["mainEvents"] = "SPELL_AURA_REMOVED{skillName;;eq;;Polymorph}",
					["message"] = "Sheep Broke!",
				},
			},
		},
		["MSBT - Rogue"] = {
			...
			["triggers"] = {
				["Custom1"] = {
					...
					["fontSize"] = 26,
					["alwaysSticky"] = true,
					["mainEvents"] = "SPELL_AURA_REMOVED{skillName;;eq;;Sap}",
					["message"] = "Sap Broke!",
				},
				["Custom2"] = {
					["classes"] = "ROGUE",
					["fontSize"] = 26,
					["alwaysSticky"] = true,
					["mainEvents"] = "SPELL_AURA_REMOVED{skillName;;eq;;Blind}",
					["message"] = "Blind Broke!",
				},
			},
		},
